 ...
 * the License.
 ******************************************************************************/
package com.mtnfog.test.prose.models.generate;
...
import com.mtnfog.prose.models.generate.BaseStandardModelGenerator;
import com.mtnfog.prose.models.generate.SentenceModelGenerator;
import com.mtnfog.test.prose.models.TestUtils;

public class SentenceModelGeneratorTest {
	...
	public void maxentQn() throws Exception {
		...
		when(model.getEncryptionkey()).thenReturn("key");
		when(model.getFile()).thenReturn(modelFile.getAbsolutePath());
		when(model.getLanguage()).thenReturn("eng");
		when(model.getType()).thenReturn(StandardModelManifest.SENTENCE);
		...
		BaseStandardModelGenerator modelGenerator = new SentenceModelGenerator();
		...
		assertEquals(StandardModelManifest.SENTENCE, modelManifest.getType());
		assertEquals("test-model", modelManifest.getName());
		assertEquals("key", modelManifest.getEncryptionKey());
