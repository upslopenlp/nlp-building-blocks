 ...
 * the License.
 ******************************************************************************/
package com.mtnfog.prose.api.exceptions;
...
import com.mtnfog.prose.model.api.exceptions.InternalServerErrorException;
import com.mtnfog.prose.model.api.exceptions.ServiceUnavailableException;
import com.mtnfog.prose.model.api.exceptions.UnauthorizedException;
...
public class RestApiExceptions {
	...
	@ResponseBody
	@ExceptionHandler({InternalServerErrorException.class, DocumentClassifierException.class})
