...
/**
 * Executable class for creating lemma models.
 * 
 * @author Mountain Fog, Inc.
 *
 */
public class LemmaModelGenerator extends BaseStandardModelGenerator {
	
	public static void main(String[] args) throws Exception {
	
		LemmaModelGenerator lemmaModelGenerator = new LemmaModelGenerator();
		lemmaModelGenerator.process(args);
	...
	public void process(String[] args) throws Exception {
		...
		output("\nIdyl E3 Lemma Model Generator");
		output("Version: " + getVersion());
		
		CommandLineParser parser = new DefaultParser();
		CommandLine cmd = parser.parse(getOptions(), args);
		
		TrainingDefinitionReader reader = getTrainingDefinitionReader(BaseRunnable.TRAINING_DEFINITION_ARGUMENT_NAME);
	...
	public File train(TrainingDefinitionReader reader) throws Exception {
		...
		// Train the model.
		final String modelId = LemmatizerModelOperations.train(reader);
