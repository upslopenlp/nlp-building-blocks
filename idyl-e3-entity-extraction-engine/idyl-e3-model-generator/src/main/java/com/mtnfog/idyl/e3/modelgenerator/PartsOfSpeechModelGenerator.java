...
/**
 * Executable class for creating parts-of-speech models.
 * 
 * @author Mountain Fog, Inc.
 *
 */
public class PartsOfSpeechModelGenerator extends BaseStandardModelGenerator {
	
	public static void main(String[] args) throws Exception {
	
		PartsOfSpeechModelGenerator posModelGenerator = new PartsOfSpeechModelGenerator();
		posModelGenerator.process(args);
	...
	public void process(String[] args) throws Exception {
		...
		output("\nIdyl E3 Parts-of-Speech Model Generator");
	...
	public File train(TrainingDefinitionReader reader) throws Exception {
		...
		// Train the model.
		final String modelId = PartOfSpeechModelOperations.train(reader);
