...
import com.mtnfog.idyl.e3.modelgenerator.LemmaModelGenerator;
...
public class LemmaModelGeneratorTest {
	...
	public void maxentQn() throws Exception {
		...
		when(model.getType()).thenReturn(StandardModelManifest.LEMMA);
		...
		LemmaModelGenerator modelGenerator = new LemmaModelGenerator();
		...
		assertEquals(StandardModelManifest.LEMMA, modelManifest.getType());
