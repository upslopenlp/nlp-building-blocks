 ...
 * the License.
 ******************************************************************************/
package com.upslopenlp.nlpbb.languagedetector.api.exceptions;
...
import com.upslopenlp.nlpbb.languagedetector.model.exceptions.BadRequestException;
...
public class RestApiExceptions {
	...
	public String handleServiceUnavailableException(LanguageDetectionException ex) {
	    return ex.getMessage();
	}
