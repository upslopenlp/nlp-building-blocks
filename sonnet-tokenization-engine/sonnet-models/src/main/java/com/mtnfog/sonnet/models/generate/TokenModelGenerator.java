...
/**
 * Executable class for creating token models.
 * 
 * @author Mountain Fog, Inc.
 *
 */
public class TokenModelGenerator extends BaseStandardModelGenerator {

	public static void main(String[] args) throws Exception {
	
		TokenModelGenerator tokenModelGenerator = new TokenModelGenerator();
		tokenModelGenerator.process(args);
	...
	public File train(TrainingDefinitionReader reader) throws Exception {
		...
		// Train the model.
		final String modelId = TokenModelOperations.train(reader);
