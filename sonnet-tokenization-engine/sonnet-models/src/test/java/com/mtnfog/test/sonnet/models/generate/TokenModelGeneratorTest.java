 ...
 * the License.
 ******************************************************************************/
package com.mtnfog.test.sonnet.models.generate;
...
import com.mtnfog.sonnet.models.generate.BaseStandardModelGenerator;
import com.mtnfog.sonnet.models.generate.TokenModelGenerator;
import com.mtnfog.test.sonnet.models.TestUtils;

public class TokenModelGeneratorTest {
	...
	public void maxentQn() throws Exception {
		...
		when(model.getType()).thenReturn(StandardModelManifest.TOKEN);
		...
		BaseStandardModelGenerator modelGenerator = new TokenModelGenerator();
		...
		assertEquals(StandardModelManifest.TOKEN, modelManifest.getType());
